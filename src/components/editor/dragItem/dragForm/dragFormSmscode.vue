<template>
    <drag-resize-form
      :dragForm="dragForm"
      :infoForm="{dragName, type: 11, listIndex, minH: 94, minW: 140}"
      :classList="'drag-item drag-sms-item'"
      ref="dragItem"
      :sticks="['ml','mr']"
      :style="{height: dragForm.size.h + 'px'}"
      >
      <template slot="content">
        <form-sms :verify="dragForm.verify" :palce="dragForm.label"/>
      </template>
    </drag-resize-form>
</template>
<script>
